/////////////////////////////////////////////////////////////////////////////////////////////
// In this script we extract point level NDVI values for July 2017-2022 for the sampled chronosequence mires
/////////////////////////////////////////////////////////////////////////////////////////////
...
var peat = ee.FeatureCollection('users/bettyehnvall/Transect_points_WGS84');
...
Export.table.toDrive({
    ...
    description: 'sd_over_tid_points_july_30',
    folder: 'user/bettyehnvall/Mires',
    fileNamePrefix: 'sd_over_tid_points_july_30',
    fileFormat: 'CSV'
})
...
Export.table.toDrive({
    ...
    description: 'mean_over_tid_points_july_30',
    folder: 'users/bettyehnvall/Mires',
    fileNamePrefix: 'mean_over_tid_points_july_30',
    fileFormat: 'CSV'
})
...
Export.table.toDrive({
    ...
    description: 'median_over_tid_points_july_30',
    folder: 'users/bettyehnvall/Mires',
    fileNamePrefix: 'median_over_tid_points_july_30',
    fileFormat: 'CSV'
})
...
Export.table.toDrive({
    ...
    description: 'medianCount_over_tid_points_july30',
    folder: 'users/bettyehnvall/Mires',
    fileNamePrefix: 'medianCount_tid_points_july30',
    fileFormat: 'CSV'
})
 
Export.table.toDrive({
    collection: minCount_over_tid_myrar,
    description: 'minCount_over_tid_points_july30',
    folder: 'users/bettyehnvall/Mires',
    fileNamePrefix: 'minCount_over_tid_points_july30',
    fileFormat: 'CSV'
})
...
Export.table.toDrive({
    ...
    description: 'maxCount_over_tid_points_july30',
    folder: 'users/bettyehnvall/Mires',
    fileNamePrefix: 'maxCount_over_tid_points_july30',
    fileFormat: 'CSV'
})
...
Export.table.toDrive({
    ...
    description: 'CountofCompositeMedian_over_tid_points_july30',
    folder: 'users/bettyehnvall/Mires',
    fileNamePrefix: 'CountofCompositeMedian_over_tid_points_july30',
    fileFormat: 'CSV'
})